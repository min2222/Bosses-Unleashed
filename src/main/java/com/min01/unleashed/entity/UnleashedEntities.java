...
public class UnleashedEntities
{
	...
	public static final RegistryObject<EntityType<CelestialOrbEntity>> CELESTIAL_ORB = registerEntity("celestial_orb", createBuilder(CelestialOrbEntity::new, MobCategory.MISC).fireImmune().sized(1.25F, 1.25F).clientTrackingRange(100));
	public static final RegistryObject<EntityType<CelestialBeamEntity>> CELESTIAL_BEAM = registerEntity("celestial_beam", createBuilder(CelestialBeamEntity::new, MobCategory.MISC).sized(0.1F, 0.1F).updateInterval(1));
	...
	public static final RegistryObject<EntityType<BearTrapEntity>> BEAR_TRAP = registerEntity("bear_trap", createBuilder(BearTrapEntity::new, MobCategory.MISC).sized(2.875F, 0.25F));
